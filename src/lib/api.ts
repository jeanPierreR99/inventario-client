...
export const API = {
  ...
  getAllDataSiga: async (page: number, limit: number) => {
    const response: any = await api.get(
      `/siga/paginate?page=${page}&limit=${limit}`
    );
  ...
  getAllDataSinabip: async (page: number, limit: number) => {
    const response: any = await api.get(
      `/sinabip/paginate?page=${page}&limit=${limit}`
    );
    return response.data.data;
  },
  ...
  getAllDataOtiComputer: async (page: number, limit: number) => {
    const response: any = await api.get(
      `/oti-computer/paginate?page=${page}&limit=${limit}`
    );
    return response.data.data;
  },
  ...
  getAllDataOtiOther: async (page: number, limit: number) => {
    const response: any = await api.get(
      `/oti-other/paginate?page=${page}&limit=${limit}`
    );
    return response.data.data;
  },
  ...
  getAllDataOtiPrinterScanner: async (page: number, limit: number) => {
    const response: any = await api.get(
      `/oti-printer-scanner/paginate?page=${page}&limit=${limit}`
    );
    return response.data.data;
  },
  getAllDataFilterOtiPrinterScanner: async (query: string) => {
    const response: any = await api.get(
      `/oti-printer-scanner/filter?query=${query}`
    );
    return response.data.data;
  },
  ...
  updateOtiPrinterScanner: async (
    id: string,
    data: Partial<IOtiPrinterScanner>
  ) => {
  ...
  getAllDataOtiRouter: async (page: number, limit: number) => {
    const response: any = await api.get(
      `/oti-router/paginate?page=${page}&limit=${limit}`
    );
    return response.data.data;
  },
  ...
  getAllDataOtiSwitch: async (page: number, limit: number) => {
    const response: any = await api.get(
      `/oti-switch/paginate?page=${page}&limit=${limit}`
    );
    return response.data.data;
  },
  ...
  getAllDataOtiUps: async (page: number, limit: number) => {
    const response: any = await api.get(
      `/oti-ups/paginate?page=${page}&limit=${limit}`
    );
    return response.data.data;
  },
  ...
  getAllDataOtiMonitor: async (page: number, limit: number) => {
    const response: any = await api.get(
      `/oti-monitor/paginate?page=${page}&limit=${limit}`
    );
    return response.data.data;
  },
  ...
  getTotalDashboard: async (query: string) => {
    const response: any = await api.get(
      `/oti-computer/total/hierarchy?query=${query}`
    );
    return response.data.data;
  },
  ...
  searchAll: async (query: string) => {
    const response: any = await api.get(
      `/oti-computer/search/all?query=${query}`
    );
    return response.data.data;
  },

  //API-AVAILABLE
  apiAvailable: async (segment: string, start: string, end: string) => {
    const response: any = await api.get(
      `/oti-computer/ip/available?segment=${segment}&start=${start}&end=${end}`
    );
    return response.data.data;
  },
};
