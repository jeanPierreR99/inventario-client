...
const Login = () => {
    ...
    return (
        <div className="h-[100dvh] bg-gray-50 flex justify-center items-center">
            <div className="flex items-center justify-center p-8 sm:p-4 w-md bg-white md:bg-transparent">
                <div className="w-full max-w-lg space-y-8 bg-white p-8 sm:p-6 rounded-2xl shadow-blue-300/20 shadow-2xl">
                    <img src="logo.png" className="w-full object-contain h-40 m-auto" alt="" />
                    <div className="text-center">
                        <h1 className="text-2xl sm:text-xl font-black text-blue-600 mb-2">INVENTARIO GENERAL</h1>
                    ...
                    <FormProvider {...loginForm}>
                        <form onSubmit={loginForm.handleSubmit(onSubmitLogin)} className="space-y-6 relative">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input className="bg-gray-50 w-full rounded-md" placeholder="Correo electronico" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                                            ...
                                            <div className="relative">
                                                <FormControl>
                                                    <Input
                                                        ...
                                                        className="bg-gray-50 w-full rounded-md pr-10"
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-blue-600 hover:bg-blue-500 text-white text-lg font-semibold rounded-lg py-3 transition-all"
                            >
                                Iniciar sesión
                            </Button>

                            <div className="text-center">
                                <p className="text-sm text-gray-500">¿No tienes cuenta? <a href="#" className="text-blue-500 hover:underline">Regístrate</a></p>
                            </div>
                        </form>
                    </FormProvider>
                </div>
